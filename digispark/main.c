...
#define I2C_FUNC_SMBUS_EMUL                                                    \
  I2C_FUNC_SMBUS_QUICK | I2C_FUNC_SMBUS_BYTE | I2C_FUNC_SMBUS_BYTE_DATA |      \
      ...
      I2C_FUNC_SMBUS_WRITE_BLOCK_DATA | I2C_FUNC_SMBUS_WRITE_BLOCK_DATA_PEC |  \
...
static uchar i2c_io_get_sda(void) { return (I2C_PIN & I2C_SDA); }
...
uchar usbFunctionSetup(uchar data[8]) {
  ...
  case CMD_SET_DELAY:
    ...
    /* --- */
    /* On littleWire-like devices, we run at 16.5MHz, so delay must be scaled
     * up. */
    {
